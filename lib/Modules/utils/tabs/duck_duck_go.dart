...
class Duck_Duck_Go extends StatefulWidget {
  const Duck_Duck_Go({super.key});

  @override
  State<Duck_Duck_Go> createState() => _Duck_Duck_GoState();
}

class _Duck_Duck_GoState extends State<Duck_Duck_Go> {
  @override
